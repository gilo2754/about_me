    ...
    <div className="min-h-screen flex items-center justify-center px-6 md:px-12 lg:px-24">
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-8">
          ...
          >
            <p className="text-teal-400 font-mono text-sm mb-6">Hi, my name is</p>
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-400 mb-6">
              From embedded electronics to modern web.
            </h2>
          </motion.div>
          ...
          >
            ...
            <span className="text-teal-400">Capgemini</span> in the Cologne Bonn Region. 
            Graduate from <span className="text-teal-400">Cologne University of Applied Sciences</span> 
            with expertise in modern web technologies, certified in Scrum methodology 
            and specialized in building innovative digital solutions.
          </motion.p>
        ...
        >
          <div className="relative">
            ...
            <div className="relative w-80 h-80 mx-auto bg-gradient-to-br from-slate-800 to-slate-700 rounded-full flex items-center justify-center float-animation">
              <div className="text-6xl text-teal-400/50">CM</div>
            </div>
