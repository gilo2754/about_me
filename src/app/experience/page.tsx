...
const experiences = [
  {
    ...
    description: [
      'Entwicklung von Enterprise-Software-Lösungen für digitale Transformationsinitiativen',
      'Arbeit mit modernen Web-Technologien wie Angular, Spring Boot und React',
      'Beitrag zu großangelegten Projekten für Tausende von Nutzern',
      'Implementierung von Best Practices in Software-Engineering und agilen Methodiken',
      'Zusammenarbeit mit internationalen Teams an innovativen digitalen Lösungen'
    ],
  ...
  },
  {
    ...
    description: [
      'Bachelor-Abschluss in Informatik mit Fokus auf Software-Engineering',
      'Spezialisierung auf Angular Advanced Forms und Backend-Grundlagen mit Spring Boot',
      'Teilnahme an Projekten mit Web-Technologien und digitaler Innovation',
      'Umfassendes Verständnis des Software-Entwicklungslebenszyklus erworben',
      'Starke Grundlage in Programmierprinzipien und Systemdesign entwickelt'
    ],
  ...
  },
  {
    ...
    location: 'Germany',
    description: [
      'Design und Entwicklung von Solar-Tracking-Systemen mit fortschrittlicher Sensortechnologie',
      'Veröffentlichte Forschung zu "Detalles de un sistema de seguimiento solar por sensores y cálculos"',
      'Implementierung automatisierter Tracking-Algorithmen für optimale Solarmodul-Positionierung',
      'Entwicklung innovativer Lösungen mit Hardware- und Software-Integration',
      'Expertise in IoT und sensorbasierten Systementwicklungen erworben'
    ],
        ...
        >
          ...
          <div className="lg:w-2/3">
            ...
            >
              ...
              <div className="pt-6">
                <h4 className="text-slate-100 font-semibold mb-4">Verwendete Technologien:</h4>
